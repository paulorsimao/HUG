...
<body>
  ...
  <div class="container mt-5">
    <h1>Bem-vindo ao HUG - House Unforeseens Guardian</h1>
    <p>Este é um sistema de gerenciamento de seguro residencial.</p>
    <p>Explore as diferentes seções do sistema utilizando o menu de navegação acima.</p>
    <div class="text-center">
        <img src="https://github.com/paulorsimao/HUG/raw/main/public/logo.jpg" class="rounded" alt="...">
    </div>
  </div>
